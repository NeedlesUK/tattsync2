/*
  ...
  2. Structure
    - Templates with sections and fields
    - Complete form structure for both tattoo and piercing
*/
...
BEGIN
  ...
  WHERE title = 'Tattoo Consent Form Template' 
  LIMIT 1;

  -- Insert sections for tattoo template
  -- Personal Details Section
  INSERT INTO consent_form_template_sections (
    template_id, title, description, display_order, is_required
  ) VALUES (
    tattoo_template_id,
    'Your Details',
  ...
  RETURNING id INTO DECLARE section_id INTEGER;

  -- Insert fields for Personal Details section
  ...
  IF section_id IS NOT NULL THEN
    ...
    -- Add radio button field for media release
    INSERT INTO consent_form_template_fields (
  ...
  IF section_id IS NOT NULL THEN
    ...
    -- Add checkbox group for medical conditions
    INSERT INTO consent_form_template_fields (
      section_id, field_name, field_type, field_label, field_options, is_required, display_order
    ) VALUES (
      section_id, 
    ...
    -- Add textarea for medical details
    INSERT INTO consent_form_template_fields (
      section_id, field_name, field_type, field_label, field_placeholder, is_required, display_order
    ) VALUES (
      section_id, 
      ...
      'textarea', 
      'Medical Details', 
      'Please provide details of any medical conditions selected above', 
      false, 
      2
    )
    ON CONFLICT DO NOTHING;
  ...
  IF section_id IS NOT NULL THEN
    ...
    -- Add radio button field for marketing consent
    INSERT INTO consent_form_template_fields (
      section_id, field_name, field_type, field_label, field_options, is_required, display_order
    ) VALUES (
      section_id, 
...
BEGIN
  ...
  WHERE title = 'Piercing Consent Form Template' 
  LIMIT 1;

  -- Insert sections for piercing template (similar structure to tattoo template)
  -- Personal Details Section
  INSERT INTO consent_form_template_sections (
    template_id, title, description, display_order, is_required
  ) VALUES (
  ...
  IF section_id IS NOT NULL THEN
    INSERT INTO consent_form_template_fields (
      ...
      (section_id, 'liabilityConfirm', 'checkbox', 'I understand neither the Piercer, Venue nor Event Organiser is responsible for any complications that may arise during or after the piercing procedure. I understand that proper aftercare is essential for healing and preventing infection.', true, 2)
    ON CONFLICT DO NOTHING;
    ...
    INSERT INTO consent_form_template_fields (
      ...
      'mediaRelease', 
      'radio', 
      'I release all rights to any photographs and video taken of me and the piercing and give consent in advance to their reproduction in print or electronic form.',
      '["Yes", "No"]',
      true, 
      3
    )
  ...
  IF section_id IS NOT NULL THEN
    INSERT INTO consent_form_template_fields (
      ...
      'noIssues', 
      'checkbox', 
      'No previous piercing issues or relevant medical issues', 
      false, 
      0
    )
    ON CONFLICT DO NOTHING;
    ...
    INSERT INTO consent_form_template_fields (
      ...
      'checkbox', 
      'Medical conditions (select all that apply)',
      '["Diabetes", "Hemophilia", "Autoimmune disorders", "Pregnant or breast feeding", "Taking blood thinning medication", "Skin condition", "Heart condition", "Keloid scarring", "Any blood-borne pathogens", "Any transmittable diseases", "Any allergies to metals", "Had any adverse reaction to a previous piercing", "Fainted during a previous piercing", "Issues with piercing healing", "Other"]',
      false, 
      1
    )
    ON CONFLICT DO NOTHING;
  ...
  IF section_id IS NOT NULL THEN
    INSERT INTO consent_form_template_fields (
      ...
      (section_id, 'eatBefore', 'checkbox', 'l confirm that I have eaten within the 2 hours of the appointment to increase my blood sugar levels.', true, 1),
      (section_id, 'unwell', 'checkbox', 'I understand that if I am unwell or unfit at the time of my appointment that I will inform my piercer and my appointment may be cancelled.', true, 2),
      (section_id, 'noAlcohol', 'checkbox', 'I will not get pierced under the influence of alcohol or drugs.', true, 3)
    ON CONFLICT DO NOTHING;
...
INSERT INTO aftercare_templates (
  ...
  'Standard aftercare instructions for tattoo procedures',
  'tattoo',
  '<!DOCTYPE html>
<html>
<head>
...
INSERT INTO aftercare_templates (
  ...
  'Standard aftercare instructions for piercing procedures',
  'piercing',
  '<!DOCTYPE html>
<html>
<head>
