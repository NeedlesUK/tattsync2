      ...
      <div className="bg-slate-800 border border-purple-500/20 rounded-xl w-full max-w-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <div>
            ...
            <p className="text-gray-300 text-sm">Set your availability and booking options</p>
          </div>
          <button
            onClick={onClose}
              ...
              {bookingStatusOptions.map((option) => (
                <label key={option.value} className="block cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setPreferences(prev => ({ ...prev, booking_status: e.target.value as any }))}
                    className="sr-only"
                  />
                      ...
                      return (
                        <label key={method.value} className="block cursor-pointer">
                          <input
                            ...
                            onChange={(e) => setPreferences(prev => ({ ...prev, contact_method: e.target.value as any }))}
                            className="sr-only"
                          />
            ...
            <div className="bg-white/5 rounded p-3">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm capitalize">Artist</p>
                </div>
              </div>
