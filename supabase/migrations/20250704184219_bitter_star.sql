/*
  # Fix Event Manager Policy and Update Admin Roles
  
  1. Safely updates RLS policies for events table
  2. Ensures the admin user has all roles
  3. Checks for existing policies before creating new ones
*/

-- Update event_manager_id column in events table if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
