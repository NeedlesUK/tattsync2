/*
  ...
  1. Updates
    ...
    - Ensures all functions use the public schema explicitly

  2. Security
    - Improves security by preventing search_path manipulation
    - Adds SECURITY DEFINER to functions that need elevated privileges
*/
