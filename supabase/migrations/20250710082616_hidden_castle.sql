/*
  ...
  1. Changes
     - Ensures 'caterer' application type exists in the enum
     - Reorders application types to place caterer before volunteer
     - Replaces max_applications with max_registrations in all application types
*/
