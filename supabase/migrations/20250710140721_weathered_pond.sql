/*
  # Fix Ticket Dependencies

  1. Changes
     - Improve check_ticket_dependencies function to handle both string and integer IDs
     - Fix check_venue_capacity function to properly handle NULL values
