/*
  # Add Caterer to Application Settings
  
  1. Changes
     - Adds 'caterer' to the default application types in the application_settings table
     - Ensures the caterer type is properly configured with default form fields
     
  This migration adds support for the 'caterer' application type in the application settings,
  allowing event managers to accept applications from caterers for their events.
*/
