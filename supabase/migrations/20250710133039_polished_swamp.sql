/*
  ...
  1. Changes
     - Drops and recreates the `check_ticket_dependencies` function with improved string comparison
     - Fixes the `check_venue_capacity` function to handle NULL arrays properly
     - Adds proper triggers for both functions

  This migration addresses an issue where ticket dependencies were not being properly validated
  due to inconsistent string/integer comparison.
*/
...
-- Create improved function to check ticket dependencies
