/*
  ...
  1. Changes
     ...
     - Create event_information_media table for storing media attachments
     - Update RLS policies for event_information to include ticket holders
     - Add RLS policies for event_information_media

  2. Security
     - Enable RLS on event_information_media
