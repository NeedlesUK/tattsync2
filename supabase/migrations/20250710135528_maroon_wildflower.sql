/*
  # Fix Ticket Types Persistence Issues

  1. New Functions
    - Improved `check_ticket_dependencies` function to handle both string and integer IDs
    - Enhanced `check_venue_capacity` function to properly handle NULL arrays
  
  2. Triggers
    - Recreate triggers for ticket dependency and venue capacity checks
  
  3. Indexes
    - Add index on dependency_ticket_id for better performance
*/
