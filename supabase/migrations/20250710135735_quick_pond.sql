/*
  # Fix Ticket Types Persistence

  1. New Functions
    - Improved `check_ticket_dependencies` to handle both string and integer IDs
    - Enhanced `check_venue_capacity` to properly handle NULL values
  
  2. Triggers
    - Recreated triggers to ensure they use the updated functions
