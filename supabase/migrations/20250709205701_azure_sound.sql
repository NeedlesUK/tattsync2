/*
  # Add event information media support

  1. New Tables
    - `event_information_media` - Stores media files for event information items
  
  2. Changes
    - Add `category` and `ticket_holders` columns to `event_information` table
  
  3. Security
    - Enable RLS on new table
    - Add policies for event managers and public viewing
    - Update existing policies to include ticket holders
*/
