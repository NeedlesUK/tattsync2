/*
  ...
  1. Updates
    - Add search_path parameter to all functions to fix security warnings
    - Ensure all functions use the 'public' schema explicitly
    - Maintain existing functionality while improving security
  
  2. Changes
    - Update get_user_roles function
    - Update set_primary_role function
    - Update add_user_role function
    - Update remove_user_role function
    - Update check_profile_visibility function
    - Update other functions with search_path warnings
*/
