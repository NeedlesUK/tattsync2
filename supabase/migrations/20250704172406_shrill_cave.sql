/*
  ...
  1. Creates a user account for Gary Watts with email gary@gwts.co.uk
  2. Assigns the event_manager role
  3. Links the user as the event manager for The Great Western Tattoo Show
